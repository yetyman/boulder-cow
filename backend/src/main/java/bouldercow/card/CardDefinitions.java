...
public class CardDefinitions {
    ...
    static {
        ...
        addCard(advancedDeck, 116, require(flax, moreThan(workerSupply)).give(wheat, 3, bonusCard, 1), gatewayCard);
        ...
        addCard(expertDeck, 218, require(wheat, moreThan(workerSupply)).give(barley, 2, hops, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(sheepDeck, 527, require(milk, moreThan(workerSupply)).give(wheat, leather, meat, bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 711, require(total(tool, jewelry, moreThan(workerSupply))).give(wheat, 3, bonusCard, 1), farmyardCard);
