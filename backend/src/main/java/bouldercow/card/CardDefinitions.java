...
import static bouldercow.flow.effects.Effect.chooseReward;
...
public class CardDefinitions {
    ...
    static {
        ...
        addCard(beginnerDeck, 4, require(clay, moreThan(workerSupply)).give(ResourceEntry.each(fieldLvl4, 1)), gatewayCard);
        ...
        addCard(beginnerDeck, 16, require(tool, 3, hops, 3).give(barley, rye, choose(2), bonusCard, 1), gatewayCard);
        addCard(beginnerDeck, 17, require(on(fieldAnyLvl, exactly(hops, 2))).give(barley, 2, rye, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(beginnerDeck, 27, require(exactly(fieldWithoutCrop, 1)).give(sowSpecificAction, 1, wool, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(advancedDeck, 102, require(flax, barley, rye, hops, choose(8)).give(sheep, 1), gatewayCard);
        ...
        addCard(advancedDeck, 105, require(sheep, moreThan(fieldAnyLvl)).give(fieldLvl3, 1), gatewayCard);
        ...
        addCard(advancedDeck, 110, require(flax, barley, rye, staged(2, 5, 7)).give(and(stagedEff(bonusCard, 0, 1, 2), hops, 1, clay, 1)), gatewayCard);
        addCard(advancedDeck, 111, require(stagedReq(tool, 3, 4, 6)).give(and(stagedEff(bonusCard, 0, 1, 2), rye, 1, clay, 1)), gatewayCard);
        ...
        addCard(advancedDeck, 114, require(stagedReq(fieldAnyLvl, 5, 6, 7)).give(and(choose(barley, flax, hops, rye, 1), stagedEff(sowAnyAction, 0, 1, 2)), bonusCard, 1), gatewayCard);
        addCard(advancedDeck, 115, require(fieldAnyLvl, 4, tool, 3).give(barley, flax, hops, rye, choose(3)), gatewayCard);
        addCard(advancedDeck, 116, require(flax, moreThan(workerSupply)).give(rye, 3, bonusCard, 1), gatewayCard);
        ...
        addCard(advancedDeck, 119, require(barley, 6, rye, 6).give(flax, 1, hops, 1, bonusCard, 1), gatewayCard);
        addCard(advancedDeck, 120, require(fieldLvl5, 3).give(hops, 1, wool, 1, bonusCard, 1), gatewayCard);
        addCard(advancedDeck, 121, require(timing(actions), stagedReq(worker, 1, 2, 3)).give(fieldUpgrade, 1, bonusCard, 1), gatewayCard);
        addCard(advancedDeck, 122, require(exactly(fieldAnyLvl, 2)).give(fieldUpgrade, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(expertDeck, 201, require(sheep, moreThan(fieldAnyLvl)).give(sheepMovementDifferent, 2, milk, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(expertDeck, 216, require(tool, jewelry, total(7)).give(rye, per(fieldWithCrop)), gatewayCard);
        addCard(expertDeck, 217, require(jewelry, 3).give(template(barley, per(maxOf(on(farmyardCard, sheep)))), bonusCard, 1), gatewayCard);
        addCard(expertDeck, 218, require(rye, moreThan(workerSupply)).give(barley, 2, hops, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(expertDeck, 222, require(timing(actions, justBeforeLastAction), exactly(fieldWithCrop, 0)).give(fieldUpgrade, 3, bonusCard, 1), gatewayCard);
        ...
        addCard(expertDeck, 228, require(fieldWithCrop, barley, rye, total(4)).give(leather, 2, bonusCard, 1), gatewayCard);
        ...
        addCard(masterDeck, 303, require(timing(removeWorkers, workersRemoved), on(quadrant, of(worker, REMOVED), 6, 7, 8, 9, 10)).give(rye, staged(0, 1, 2, 3, 5), sheep, 1), gatewayCard);
        addCard(masterDeck, 304, require(tool, staged(3, 7, 10)).give(sheep, staged(0, 1, 2), fieldLvl2, 1), gatewayCard);
        addCard(masterDeck, 305, require(timing(buildings, craftBuildingAdvanced), staged(3, 4, 5)).give(bonusCard, staged(0, 1, 2), fieldLvl5, 1), gatewayCard);
        ...
        addCard(masterDeck, 309, require(timing(useActionSpace), on(quadrant, of(worker, TOTAL), 9, 11, 13)).give(barley, staged(1, 2, 3), tool, 1), gatewayCard);
        addCard(masterDeck, 310, require(timing(toolsObtained), tool, staged(2, 3, 4)).give(hops, staged(1, 2, 3), tool, 1), gatewayCard);
        addCard(masterDeck, 311, require(same(anyCrops, 7, 14, 21)).give(bonusCard, staged(0, 1, 2), jewelry, 1), gatewayCard);
        ...
        addCard(masterDeck, 330, require(timing(actions, toolsObtained), staged(1, 3, 5)).give(gatewayCard, staged(0, 1, 2), bonusCard, 1), gatewayCard);
        ...
        addCard(hopsDeck, 419, consume(timing(actions, true), jewelry, 1).give(useActionSpace, 1), farmyardCard);
        ...
        addCard(hopsDeck, 422, require(on(fieldAnyLvl, exactly(hops, 1, 2, 3))).give(barley, staged(0, 2, 4), bonusCard, 1), farmyardCard);
        addCard(hopsDeck, 423, require(meat, each(5), wool, each(3)).give(flax, 3, bonusCard, 1), farmyardCard);
        addCard(hopsDeck, 424, consume(hops, 3).give(rye, 5, bonusCard, 1), farmyardCard);
        addCard(hopsDeck, 425, consume(hops, 8).give(hops, 3, barley, 3, bonusCard, 2), farmyardCard);
        addCard(hopsDeck, 426, require(timing(Phase.harvest), tool, each(6)).give(doubleHarvest, 1), farmyardCard);
        addCard(hopsDeck, 427, consume(timing(Phase.harvest, true), milk, choose(0, 1, 3)).give(sowAnyAction, staged(1, 2, 3)), farmyardCard);
        ...
        addCard(sheepDeck, 502, require(jewelry, staged(4, 5, 6, 8)).give(rye, staged(0, 1, 2, 3), sheep, 1), farmyardCard);
        addCard(sheepDeck, 503, require(minOf(fieldAnyLvl, jewelry, staged(3, 5, 7))).give(sheep, staged(0, 1, 2), meat, 2), farmyardCard);
        ...
        addCard(sheepDeck, 523, require(tool, each(4), fieldAnyLvl, each(5)).give(barley, flax, hops, rye, choose(4)), farmyardCard);
        addCard(sheepDeck, 524, require(on(fieldAnyLvl, hops, 1, 2, 3)).give(barley, staged(2, 3, 4), bonusCard, staged(0, 1, 2)), farmyardCard);
        addCard(sheepDeck, 525, require(fieldAnyLvl, tool, total(9, 10, 11, 12)).give(flax, staged(2, 3, 4, 5)), farmyardCard);
        addCard(sheepDeck, 526, consume(timing(Phase.harvest, true), milk, 2).give(sowAnyAction, upTo(3)), farmyardCard);
        addCard(sheepDeck, 527, require(milk, moreThan(workerSupply)).give(rye, leather, meat, bonusCard, 1), farmyardCard);
        ...
        addCard(fieldDeck, 605, consume(timing(milking, true), milk, 3).give(sheep, 1, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 606, require(same(fieldWithCrop, 3)).give(fieldLvl3, 1, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 607, require(tool, each(6), jewelry, each(4)).give(total(fieldAnyLvl, LEVEL, per(jewelry), upTo(fieldAnyLvl, 2))), farmyardCard);//Field total level = jewelry, distribute amongst 2 fields max.
        ...
        addCard(fieldDeck, 615, require(jewelry, staged(5, 6, 7, 8)).give(stagedEff(Effect.of(of(tool, 2)), chooseReward(each(tool, 2), upTo(fieldLvl2, 2)), chooseReward(each(tool, 2), upTo(fieldLvl2, 2), upTo(fieldLvl5, 2)), chooseReward(each(tool, 2), upTo(fieldLvl2, 2), upTo(fieldLvl5, 2), each(sheep, 3)))), farmyardCard);
        ...
        addCard(fieldDeck, 624, require(total(sheep, fieldAnyLvl, moreThan(workerSupply))).give(flax, 2, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 625, require(jewelry, moreThan(fieldAnyLvl)).give(barley, hops, rye, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 626, consume(fieldAnyLvl, 1).give(barley, 3, hops, 1, rye, 3), farmyardCard);
        addCard(fieldDeck, 627, require(tool, each(7)).give(sowDoubleCrop, 1), farmyardCard);
        addCard(fieldDeck, 628, require(on(fieldAnyLvl, different(anyCrops, 4))).give(harvestAction, upTo(3), bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 629, require(minOf(sheep, jewelry, staged(3, 5, 6, 7))).give(leather, staged(1, 2, 3, 4), meat, staged(1, 2, 3, 4)), farmyardCard);
        addCard(fieldDeck, 630, require(on(fieldAnyLvl, anyCrops, 6)).give(leather, meat, wool, bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 702, require(timing(actions, workersExchangedForTools), worker, each(3)).give(sheep, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 706, require(timing(Phase.harvest, harvest), on(harvest, of(anyCrops, SAME, 11))).give(tool, 1, jewelry, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 709, require(subtract(maxOf(craftBuilding), minOf(craftBuilding), 4)).give(jewelry, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 713, require(timing(cardPlayedAfterGotten)).give(of(milk, 1), of(bonusCard, 1), of(barley, flax, hops, rye, choose(1))), farmyardCard);
        addCard(jewelryDeck, 714, require(on(fieldAnyLvl, flax, 1, 2, 3)).give(wool, staged(1, 3, 4), bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 718, consume(CHOOSE, of(leather, 3), of(hops, 4)).give(fieldLvl3, upTo(2), bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 719, consume(jewelry, choose(2, 7, 9)).give(template(jewelry, staged(0, 6, 9)), upTo(fieldLvl3, 2), of(bonusCard, 1)), farmyardCard);
        addCard(jewelryDeck, 720, consume(sheep, 1).give(clay, 2, tool, 2, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 721, consume(jewelry, 1).give(choose(barley, flax, hops, rye, 1), tool, 3, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 722, consume(hops, 3).give(tool, 1, jewelry, 1, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 723, consume(CHOOSE, of(flax, 7, leather, 0), of(flax, 5, leather, 1), of(flax, 3, leather, 2), of(flax, 1, leather, 3), of(leather, 4)).give(jewelry, 2, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 724, consume(timing(Phase.harvest, true), barley, per(fieldWithoutCrop)).give(jewelry, 1), farmyardCard);
        ...
        addCard(bonusDeck, 802, consume(hops, 1).give(recurring(income, barley, 1), vp, 2), bonusCard);
        addCard(bonusDeck, 803, consume(meat, 2).give(recurring(income, sheep, 1), vp, 2), bonusCard);
        addCard(bonusDeck, 804, consume(meat, 1).give(recurring(income, wool, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 805, consume(sheep, 1).give(recurring(income, leather, 2), vp, 3), bonusCard);
        addCard(bonusDeck, 806, consume(sheep, 1).give(recurring(income, milk, 2), vp, 3), bonusCard);
        addCard(bonusDeck, 807, consume(fieldAnyLvl, 2).give(recurring(income, sheep, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 808, consume(leather, 2).give(recurring(income, wool, 2), vp, 3), bonusCard);
        addCard(bonusDeck, 809, consume(tool, 2).give(recurring(income, each(barley, hops, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 810, consume(hops, 2).give(recurring(income, rye, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 811, consume(timing(justHarvested), flax, 3).give(recurring(income, each(sowSpecificAction, flax, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 812, consume(timing(justHarvested), barley, 3).give(recurring(income, each(sowSpecificAction, barley, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 813, consume(hops, 3).give(recurring(income, tool, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 814, consume(clay, 3).give(recurring(income, each(rye, clay, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 815, consume(on(hand, anyCard, 3)).give(recurring(income, gatewayCard, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 816, consume(timing(justHarvested), rye, 3).give(recurring(income, each(sowSpecificAction, rye, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 817, consume(jewelry, 1).give(recurring(income, tool, 1), vp, 4), bonusCard);
        addCard(bonusDeck, 818, consume(jewelry, 1, tool, 1).give(recurring(income, each(flax, wool, 1)), vp, 4), bonusCard);
        addCard(bonusDeck, 819, consume(fieldAnyLvl, 2).give(recurring(income, fieldLvl4, 1), vp, 4), bonusCard);
        addCard(bonusDeck, 820, consume(tool, 2).give(recurring(income, meat, 1), vp, 4), bonusCard);
        addCard(bonusDeck, 821, consume(clay, 4).give(recurring(income, clay, 2), vp, 4), bonusCard);
        addCard(bonusDeck, 822, consume(barley, flax, hops, rye, choose(3)).give(recurring(income, hops, 1), vp, 5), bonusCard);
        addCard(bonusDeck, 823, consume(sheep, 2).give(recurring(income, sheep, 1), vp, 5), bonusCard);
        addCard(bonusDeck, 824, consume(on(fieldAnyLvl, anyCrops, 1)).give(recurring(income, fieldLvl3, 1), vp, 6), bonusCard);
        addCard(bonusDeck, 825, consume(fieldAnyLvl, 3).give(recurring(income, fieldLvl5, 1), vp, 6), bonusCard);
        addCard(bonusDeck, 826, consume(jewelry, 2).give(recurring(income, barley, 2), vp, 7), bonusCard);
        addCard(bonusDeck, 827, consume(jewelry, 3).give(recurring(income, jewelry, 1), vp, 8), bonusCard);
        addCard(bonusDeck, 828, require(fieldWithoutCrop, exactly(0)).give(recurring(income, hops, 1), vp, 2), bonusCard);
        addCard(bonusDeck, 829, require(sheep, 5).give(recurring(income, wool, 1), vp, 2), bonusCard);
        addCard(bonusDeck, 830, require(clay, 7).give(recurring(income, clay, 1), vp, 2), bonusCard);
        addCard(bonusDeck, 831, require(total(fieldLvl2, fieldLvl3, fieldLvl4, exactly(0))).give(recurring(income, sowAnyAction, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 832, require(total(fieldLvl2, fieldLvl3, fieldLvl4, exactly(0))).give(recurring(income, milk, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 833, require(milk, moreThan(roundNumber, 2d)).give(recurring(income, leather, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 834, require(leather, 3).give(recurring(income, leather, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 835, require(jewelry, 5).give(recurring(income, meat, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 836, require(hops, 6).give(recurring(income, rye, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 837, require(wool, 6).give(recurring(income, wool, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 838, require(flax, 7).give(recurring(income, flax, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 839, require(tool, 8).give(recurring(income, exchange(tool, jewelry, 1)), vp, 3), bonusCard);
        addCard(bonusDeck, 840, require(of(tool, 3), of(sheep, 3), of(jewelry, 3)).give(recurring(income, farmyardCard, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 841, require(barley, 10).give(recurring(income, barley, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 842, require(barley, 7, hops, 5).give(recurring(income, barley, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 843, require(milk, 7, sheep, 6).give(recurring(income, sheep, 1), vp, 3), bonusCard);
        addCard(bonusDeck, 844, require(rye, 6, meat, 5).give(recurring(income, each(rye, meat, 1)), vp, 4), bonusCard);
        addCard(bonusDeck, 845, require(meat, 6).give(recurring(income, meat, 1), vp, 6), bonusCard);
        ...
        addCard(pointDeck, 918, consume(CHOOSE, of(wool, 13), of(milk, 16)).give(vp, 10), pointCard);
