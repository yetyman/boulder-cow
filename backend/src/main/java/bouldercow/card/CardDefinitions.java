...
public class CardDefinitions {
    ...
    static {
        ...
        addCard(beginnerDeck, 17, require(fieldWithCrop, hops, each(2)).give(barley, 2, rye, 1, bonusCard, 1), gatewayCard);
        ...
        addCard(sheepDeck, 514, consume(anyGoods, same(2)).give(tool, 1, fieldLvl2, 1), farmyardCard);
        ...
        addCard(sheepDeck, 529, require(anyCrops, same(10)).give(meat, 2, bonusCard, 1), farmyardCard);
        ...
        addCard(fieldDeck, 606, require(fieldWithCrop, same(3)).give(fieldLvl3, 1, bonusCard, 1), farmyardCard);
        ...
        addCard(fieldDeck, 628, require(fieldWithCrop, different(4)).give(harvestAction, upTo(3), bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 712, require(or(stagedReq(jewelry, 3, 5, 7), stagedReq(tool, 6, 8, 10))).give(flax, staged(2, 3, 4), bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 718, consume(or(each(leather, 3), each(hops, 4))).give(fieldLvl3, upTo(2), bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 723, consume(or(of(flax, 7, leather, 0), of(flax, 5, leather, 1), of(flax, 3, leather, 2), of(flax, 1, leather, 3), of(leather, 4))).give(jewelry, 2, bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 727, consume(or(of(jewelry, 1), of(tool, 3))).give(clay, 7), farmyardCard);
        ...
        addCard(bonusDeck, 836, require(hops, each(6)).give(recurring(phase3, rye, 1), vp, 3), bonusCard);
        ...
        addCard(bonusDeck, 844, require(rye, each(6), meat, each(5)).give(recurring(phase3, each(rye, meat, 1)), vp, 4), bonusCard);
        ...
        addCard(pointDeck, 908, consume(anyGoods, 4), choose(barley, flax, hops, rye, rye, wool, milk, clay, meat, leather, jewelry, 4)).give(vp, 8), pointCard);
        ...
        addCard(pointDeck, 919, consume(choose(barley, flax, hops, rye, rye, wool, milk, clay, meat, leather, jewelry, 14)).give(vp, 10), pointCard);
