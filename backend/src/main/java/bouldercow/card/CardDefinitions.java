...
public class CardDefinitions {
    ...
    static {
        ...
        addCard(fieldDeck, 601, consume(fieldAnyLvl, each(6)).give(sheep, 1), farmyardCard);
        addCard(fieldDeck, 602, consume(wool, each(2), tool, each(4)).give(sheep, 1), farmyardCard);
        ...
        addCard(fieldDeck, 606, consume(fieldWithSameCrop, each(3)).give(fieldLvl3, 1, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 607, consume(tool, each(6), jewelry, each(4)).give(fieldsWithRowSum, per(jewelry)), farmyardCard);
        addCard(fieldDeck, 608, consume(meat, staged(1, 2, 5, 7)).give(wool, staged(0, 1, 2, 3), fieldLvl4, 1), farmyardCard);
        addCard(fieldDeck, 609, consume(sheep, jewelry, total(), moreThan(workerSupply)).give(tool, 1, fieldLvl5, 1), farmyardCard);
        ...
        addCard(fieldDeck, 615, consume(jewelry, staged(5, 6, 7, 8)).give(stagedEff(each(tool, 2), choose(each(tool, 2), upTo(fieldLvl2, 2)), choose(each(tool, 2), upTo(fieldLvl2, 2), upTo(fieldLvl5, 2)), choose(each(tool, 2), upTo(fieldLvl2, 2), upTo(fieldLvl5, 2), each(sheep, 3)))), farmyardCard);
        addCard(fieldDeck, 616, consume(leather, staged(1, 2, 5, 7)).give(meat, staged(1, 2, 3, 4), tool, 1), farmyardCard);
        ...
        addCard(fieldDeck, 619, consume(wool, staged(4, 9, 16)).give(jewelry, staged(1, 2, 3)), farmyardCard);
        ...
        addCard(fieldDeck, 624, consume(sheep, fieldAnyLvl, total(), moreThan(workerSupply)).give(flax, 2, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 625, consume(jewelry, moreThan(fieldAnyLvl)).give(barley, hops, wheat, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 626, consume(fieldAnyLvl, 1).give(barley, 3, hops, 1, wheat, 3), farmyardCard);
        addCard(fieldDeck, 627, consume(tool, each(7)).give(sowDoubleCrop, 1), farmyardCard);
        addCard(fieldDeck, 628, consume(allFourCropTypes, 1).give(harvestAction, upTo(3), bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 629, consume(minOfTwo(sheep, jewelry), staged(3, 5, 6, 7)).give(leather, staged(1, 2, 3, 4), meat, staged(1, 2, 3, 4)), farmyardCard);
        addCard(fieldDeck, 630, consume(fieldWithCrop, each(6)).give(leather, meat, wool, bonusCard, 1), farmyardCard);
        addCard(fieldDeck, 631, consume(tool, 2).give(hidesEqualToTools, 1, bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 701, consume(barley, each(11)).give(sheep, 1), farmyardCard);
        addCard(jewelryDeck, 702, consume(timing(phase4, workersExchangedForTools), worker, each(3)).give(sheep, 1), farmyardCard);
        addCard(jewelryDeck, 703, consume(actionSpaceFullyOccupied, 1).give(sheep, 1, fieldLvl2, 1), farmyardCard);
        addCard(jewelryDeck, 704, consume(sheep, each(4), fieldAnyLvl, atMost(7, 5, 4, 3)).give(fieldLvl2, fieldLvl3, fieldLvl4, fieldLvl5, staged(1, 1, 1, 1)), farmyardCard);
        addCard(jewelryDeck, 705, consume(sheep, each(4), tool, atMost(7, 4, 1)).give(tool, staged(1, 2, 3), bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 706, consume(timing(phase7, harvestedSameTypeCrops), sameTypeCrops, each(11)).give(tool, 1, jewelry, 1), farmyardCard);
        addCard(jewelryDeck, 707, consume(tool, staged(2, 6, 10)).give(jewelry, staged(0, 1, 2), leather, 1, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 708, consume(tool, fieldAnyLvl, total(12)).give(jewelry, 1), farmyardCard);
        addCard(jewelryDeck, 709, consume(craftBuildingGap, each(4)).give(jewelry, 1), farmyardCard);
        addCard(jewelryDeck, 710, consume(tool, sheep, total(8, 11, 16)).give(bonusCard, staged(0, 1, 2), barley, 2, hops, 1, clay, 2), farmyardCard);
        addCard(jewelryDeck, 711, consume(tool, jewelry, total(), moreXThanY(workerSupply)).give(wheat, 3, bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 712, consume(jewelry, staged(3, 5, 7), tool, staged(6, 8, 10), choose(1)).give(flax, staged(2, 3, 4), bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 713, consume(timing(cardPlayedAfterGotten)).give(milk, 1, bonusCard, 1, barley, flax, hops, wheat, choose(1)), farmyardCard);
        addCard(jewelryDeck, 714, consume(fieldWithCrop, flax, staged(1, 2, 3)).give(wool, staged(1, 3, 4), bonusCard, 1), farmyardCard);
        addCard(jewelryDeck, 715, consume(moreXThanY(sheep, fieldAnyLvl)).give(meat, 2, bonusCard, 1), farmyardCard);
        ...
        addCard(jewelryDeck, 721, consume(jewelry, 1).give(tool, 3, bonusCard, 1, barley, flax, hops, wheat, choose(1)), farmyardCard);
        ...
        addCard(jewelryDeck, 728, consume(cropsAbove3, returnToThree).give(sowAnyAction, upTo(3), bonusCard, 1), farmyardCard);
        ...
        addCard(bonusDeck, 828, consume(fieldWithoutCrop, exactly(0)).give(recurring(phase3, hops, 1), scoring(vp, 2)), bonusCard);
        addCard(bonusDeck, 829, consume(sheep, each(5)).give(recurring(phase3, wool, 1), scoring(vp, 2)), bonusCard);
        addCard(bonusDeck, 830, consume(clay, each(7)).give(recurring(phase3, clay, 1), scoring(vp, 2)), bonusCard);
        addCard(bonusDeck, 831, consume(fieldLvl2, exactly(0), fieldLvl3, exactly(0), fieldLvl4, exactly(0)).give(recurring(phase3, sowAnyAction, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 832, consume(fieldLvl2, exactly(0), fieldLvl3, exactly(0), fieldLvl4, exactly(0)).give(recurring(phase3, milk, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 833, consume(milk, moreXThanY(doubleRoundNumber)).give(recurring(phase3, leather, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 834, consume(leather, each(3)).give(recurring(phase3, leather, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 835, consume(jewelry, each(5)).give(recurring(phase3, meat, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 836, consume(hops, each(6)).give(recurring(phase3, wheat, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 837, consume(wool, each(6)).give(recurring(phase3, wool, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 838, consume(flax, each(7)).give(recurring(phase3, flax, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 839, consume(tool, each(8)).give(recurring(phase3, toolToJewelryExchange, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 840, consume(tool, each(3), sheep, each(3), jewelry, each(3)).give(recurring(phase3, farmyardCard, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 841, consume(barley, each(10)).give(recurring(phase3, barley, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 842, consume(barley, each(7), hops, each(5)).give(recurring(phase3, barley, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 843, consume(milk, each(7), sheep, each(6)).give(recurring(phase3, sheep, 1), scoring(vp, 3)), bonusCard);
        addCard(bonusDeck, 844, consume(wheat, each(6), meat, each(5)).give(recurring(phase3, wheat, 1, meat, 1), scoring(vp, 4)), bonusCard);
        addCard(bonusDeck, 845, consume(meat, each(6)).give(recurring(phase3, meat, 1), scoring(vp, 6)), bonusCard);
        ...
        addCard(pointDeck, 903, require(tool, 3).give(vp, 4), pointCard);
        addCard(pointDeck, 904, require(gatewayCard, 6).give(vp, 5), pointCard);
        addCard(pointDeck, 905, require(tool, 4).give(vp, 6), pointCard);
        addCard(pointDeck, 906, require(farmyardCard, 6).give(vp, 6), pointCard);
        addCard(pointDeck, 907, require(choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 5), choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 5)).give(vp, 7), pointCard);
        addCard(pointDeck, 908, require(choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 4), choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 4), choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 4)).give(vp, 8), pointCard);
        addCard(pointDeck, 909, require(hide, 2, jewelry, 3).give(vp, 10), pointCard);
        addCard(pointDeck, 910, require(meat, 5).give(vp, 10), pointCard);
        addCard(pointDeck, 911, require(barley, 6, jewelry, 2).give(vp, 10), pointCard);
        addCard(pointDeck, 912, require(hops, 10).give(vp, 10), pointCard);
        addCard(pointDeck, 913, require(choose(barley, flax, hops, rye, 11)).give(vp, 10), pointCard);
        addCard(pointDeck, 914, require(flax, 6, hops, 6).give(vp, 10), pointCard);
        addCard(pointDeck, 915, require(hops, 6, rye, 6).give(vp, 10), pointCard);
        addCard(pointDeck, 916, require(clay, 12).give(vp, 10), pointCard);
        addCard(pointDeck, 917, require(wool, 12).give(vp, 10), pointCard);
        addCard(pointDeck, 918, require(choose(wool, 13, milk, 16)).give(vp, 10), pointCard);
        addCard(pointDeck, 919, require(choose(barley, flax, hops, rye, wheat, wool, milk, clay, meat, leather, jewelry, 14)).give(vp, 10), pointCard);
        addCard(pointDeck, 920, require(milk, 14).give(vp, 10), pointCard);
        addCard(pointDeck, 921, require(jewelry, 4).give(vp, 12), pointCard);
        addCard(pointDeck, 922, require(removeFieldsNotRow2, 7).give(vp, 12), pointCard);
        addCard(pointDeck, 923, require(sheep, 8).give(vp, 12), pointCard);
        addCard(pointDeck, 924, require(removeFields, 8).give(vp, 13), pointCard);
        addCard(pointDeck, 925, require(choose(jewelry, 5, sheep, 10)).give(vp, 14), pointCard);
    }
